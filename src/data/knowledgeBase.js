...
const knowledgeBase = [
  // ── Kategori 1: Edukasi Dasar & Validasi ─────────────────────
  {
    ...
    referensi: "Liu, C., Zhao, G., Qiao, D., Wang, L., He, Y., Zhao, M., Fan, Y., & Jiang, E. (2022). Emerging Progress in Nausea and Vomiting of Pregnancy and Hyperemesis Gravidarum: Challenges and Opportunities. Frontiers in Medicine",
    jawaban:
  ...
  },
  {
    ...
    referensi: "Festin, M. (2014). Nausea and vomiting in early pregnancy. Clinical Evidence",
    jawaban:
  ...
  },
  {
    ...
    referensi: "Lee, N. M., & Saha, S. (2011). Nausea and Vomiting of Pregnancy. Gastroenterology Clinics of North America",
    jawaban:
  ...
  // ── Kategori 3: Terapi Alami (Non-Farmakologis) ──────────────
  {
    ...
    referensi: "Lete, I., & Allué, J. (2016). The Effectiveness of Ginger in the Prevention of Nausea and Vomiting during Pregnancy and Chemotherapy. Integrative Medicine Insights",
    jawaban:
  ...
  },
  {
    ...
    referensi: "Park, E. Y., Tsuyuki, K. M., Hu, F., Lee, J., & Jeong, J. (2019). PRC2-Mediated H3K27me3 Contributes to Transcriptional Regulation of FIT-Dependent Iron Deficiency Response. Frontiers in Plant Science",
    jawaban:
  ...
  },
  {
    ...
    referensi: "Molina-Serrano, D., Kyriakou, D., & Kirmizis, A. (2019). Histone Modifications as an Intersection Between Diet and Longevity. Frontiers in Genetics",
    jawaban:
  ...
  },
  {
    ...
    referensi: "Dunkel Schetter, C., & Tanner, L. (2012). Anxiety, depression and stress in pregnancy: implications for mothers, children, research, and practice. Current Opinion in Psychiatry",
    jawaban:
...
export function findAnswer(userQuestion, threshold = 0.3) {
  ...
  for (const item of knowledgeBase) {
    ...
    if (score > bestScore) {
      bestScore = score;
      bestAnswer = item.jawaban + `\n\n*(Referensi: ${item.referensi || "Afidah, A. (2023). Panduan Edukasi Emesis Gravidarum. Jurnal Kesehatan Ibu."})*`;
    }
  }
