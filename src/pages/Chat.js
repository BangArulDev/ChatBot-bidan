  ...
  return (
    ...
    >
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-gray-200 z-40">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600 mb-3 px-4">
              Media informasi untuk meningkatkan pengetahuan ibu hamil tentang
      ...
      <div className="w-full h-full bg-white shadow-lg overflow-hidden flex flex-col relative z-10">
        ...
        <footer className="bg-white border-t border-gray-100 p-3">
          <div className="flex items-center space-x-2 mb-3">
            ...
            <button
              ...
              className="flex-1 bg-gray-100 text-gray-700 px-3 py-2 rounded-full text-sm font-medium flex items-center justify-center space-x-1.5 hover:bg-gray-200 transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
        ...
        {/* Modal Artikel Kesehatan */}
        {showArticlesModal && (
          <div
            className="absolute inset-0 bg-gray-900 bg-opacity-50 flex flex-col items-center justify-end z-50 animate-fade-in"
            onClick={() => setShowArticlesModal(false)}
          >
            <div
              className="bg-white rounded-t-2xl w-full max-w-md p-6 shadow-2xl animate-slide-up"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex justify-between items-center mb-4">
                <h3 className="font-bold text-gray-900 text-lg">
                  Pilih Artikel Kesehatan
                </h3>
                <button
                  onClick={() => setShowArticlesModal(false)}
              ...
              <ul className="space-y-3 max-h-[60vh] overflow-y-auto pr-2">
                <li className="bg-gray-50 hover:bg-pink-50 rounded-lg transition-colors border border-gray-100">
                  <a
                    href={process.env.PUBLIC_URL + "/artikel1.pdf"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block p-4"
                  >
                    <h4 className="font-semibold text-gray-800">
                      Artikel 1: Aromaterapi dan Cara Mengatasi Bau
                    </h4>
                    <p className="text-xs text-gray-500 mt-1">
                      Panduan mengatasi mual karena aroma
                    </p>
                  </a>
                </li>
                <li className="bg-gray-50 hover:bg-pink-50 rounded-lg transition-colors border border-gray-100">
                  <a
                    href={process.env.PUBLIC_URL + "/artikel2.pdf"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block p-4"
                  >
                    <h4 className="font-semibold text-gray-800">
                      Artikel 2: Waktu Berhentinya Mual
                    </h4>
                    <p className="text-xs text-gray-500 mt-1">
                      Penjelasan timeline mual saat kehamilan
                    </p>
                  </a>
                </li>
                <li className="bg-gray-50 hover:bg-pink-50 rounded-lg transition-colors border border-gray-100">
                  <a
                    href={process.env.PUBLIC_URL + "/artikel3.pdf"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block p-4"
                  >
                    <h4 className="font-semibold text-gray-800">
                      Artikel 3: Terapi Olahraga Ringan
                    </h4>
                    <p className="text-xs text-gray-500 mt-1">
                      Gerakan mudah untuk mengurangi keluhan
                    </p>
                  </a>
                </li>
                <li className="bg-gray-50 hover:bg-pink-50 rounded-lg transition-colors border border-gray-100">
                  <a
                    href={process.env.PUBLIC_URL + "/artikel4.pdf"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block p-4"
                  >
                    <h4 className="font-semibold text-gray-800">
                      Artikel 4: Penyebab Mual dan Dampaknya
                    </h4>
                    <p className="text-xs text-gray-500 mt-1">
                      Pemahaman dasar soal stres dan mual
                    </p>
                  </a>
                </li>
                <li className="bg-gray-50 hover:bg-pink-50 rounded-lg transition-colors border border-gray-100">
                  <a
                    href={process.env.PUBLIC_URL + "/artikel5.pdf"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block p-4"
                  >
                    <h4 className="font-semibold text-gray-800">
                      Artikel 5: Terapi Pijat (Akupresur)
                    </h4>
                    <p className="text-xs text-gray-500 mt-1">
                      Titik pijat yang aman untuk meredakan emesis
                    </p>
                  </a>
                </li>
                <li className="bg-gray-50 hover:bg-pink-50 rounded-lg transition-colors border border-gray-100">
                  <a
                    href={process.env.PUBLIC_URL + "/artikel6.pdf"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block p-4"
                  >
                    <h4 className="font-semibold text-gray-800">
                      Artikel 6: Obat Alami Menghilangkan Mual
                    </h4>
                    <p className="text-xs text-gray-500 mt-1">
                      Penggunaan ramuan herbal herbal seperti jahe
                    </p>
                  </a>
                </li>
                <li className="bg-gray-50 hover:bg-pink-50 rounded-lg transition-colors border border-gray-100">
                  <a
                    href={process.env.PUBLIC_URL + "/artikel7.pdf"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block p-4"
                  >
                    <h4 className="font-semibold text-gray-800">
                      Artikel 7: Manajemen Nutrisi Lengkap
                    </h4>
                    <p className="text-xs text-gray-500 mt-1">
                      Solusi tidak bisa makan nasi dan cara atasi mual pagi
                    </p>
                  </a>
                </li>
                <li className="bg-gray-50 hover:bg-pink-50 rounded-lg transition-colors border border-gray-100">
                  <a
                    href={process.env.PUBLIC_URL + "/artikel8.pdf"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block p-4"
                  >
                    <h4 className="font-semibold text-gray-800">
                      Artikel 8: Manajemen Stres Ibu Hamil
                    </h4>
                    <p className="text-xs text-gray-500 mt-1">
                      Solusi kesehatan mental agar tidak khawatir dan sedih
                    </p>
                  </a>
                </li>
              </ul>
